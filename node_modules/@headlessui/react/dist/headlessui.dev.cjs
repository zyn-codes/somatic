...
function HoistFormFields({ children }) {
  ...
  return target ? (0, import_react_dom2.createPortal)(/* @__PURE__ */ import_react21.default.createElement(import_react21.default.Fragment, null, children), target) : null;
}
function FormFields({
  data,
  form: formId,
...
function useElementSize(enabled, element, unit = false) {
  let [size3, setSize] = (0, import_react30.useState)(() => computeSize(element));
  useIsoMorphicEffect(() => {
    if (!element)
      return;
    if (!enabled)
...
function useFlags(initialFlags = 0) {
  ...
  let setFlag = (0, import_react43.useCallback)((flag) => setFlags(flag), []);
  let addFlag = (0, import_react43.useCallback)((flag) => setFlags((flags2) => flags2 | flag), []);
  let hasFlag = (0, import_react43.useCallback)((flag) => (flags & flag) === flag, [flags]);
  let removeFlag = (0, import_react43.useCallback)((flag) => setFlags((flags2) => flags2 & ~flag), []);
  let toggleFlag = (0, import_react43.useCallback)((flag) => setFlags((flags2) => flags2 ^ flag), []);
...
function LegendFn(props, ref) {
  return /* @__PURE__ */ import_react71.default.createElement(Label, { as: "div", ref, ...props });
}
...
function useListboxMachine({
  ...
  let machine = (0, import_react73.useMemo)(() => ListboxMachine.new({ id, __demoMode }), []);
  useOnUnmount(() => machine.dispose());
  return machine;
}
...
function ListboxFn(props, ref) {
  ...
  let isTopLayer = useSlice(
    stackMachine,
    (0, import_react74.useCallback)((state) => stackMachine.selectors.isTop(state, id), [stackMachine, id])
  );
...
function ButtonFn4(props, ref) {
  ...
  useQuickRelease(enableQuickRelease, {
    ...
    action: (0, import_react74.useCallback)(
      (e) => {
  ...
  let pointerTypeRef = (0, import_react74.useRef)(null);
  let handlePointerDown = useEvent((event) => {
...
function OptionsFn2(props, ref) {
  ...
  let shouldFreeze = visible && listboxState === 1 /* Closed */ && !props.static;
  let frozenValue = useFrozenData(shouldFreeze, data.value);
  let isSelected = (0, import_react74.useCallback)(
    (compareValue) => data.compare(frozenValue, compareValue),
    [data.compare, frozenValue]
...
function useMenuMachine({ id, __demoMode = false }) {
  let machine = (0, import_react75.useMemo)(() => MenuMachine.new({ id, __demoMode }), []);
  useOnUnmount(() => machine.dispose());
  return machine;
}
...
function ButtonFn5(props, ref) {
  ...
  useQuickRelease(enableQuickRelease, {
    ...
    close: (0, import_react76.useCallback)(() => machine.send({ type: 1 /* CloseMenu */ }), []),
    select: (0, import_react76.useCallback)((target) => target.click(), [])
  });
  let toggle = useEvent((event) => {
    var _a3;
    if (event.button !== 0 /* Left */)
...
function usePopoverMachine({
  ...
  let machine = (0, import_react77.useMemo)(() => PopoverMachine.new({ id, __demoMode }), []);
  useOnUnmount(() => machine.dispose());
  return machine;
}

// src/components/popover/popover.tsx
var PopoverGroupContext = (0, import_react78.createContext)(null);
PopoverGroupContext.displayName = "PopoverGroupContext";
function usePopoverGroupContext() {
  return (0, import_react78.useContext)(PopoverGroupContext);
}
var PopoverPanelContext = (0, import_react78.createContext)(null);
PopoverPanelContext.displayName = "PopoverPanelContext";
function usePopoverPanelContext() {
  return (0, import_react78.useContext)(PopoverPanelContext);
}
...
function PopoverFn(props, ref) {
  ...
  let internalPopoverRef = (0, import_react78.useRef)(null);
  ...
  let [popoverState, button, panel, buttonId, panelId] = useSlice(
    machine,
    (0, import_react78.useCallback)((state) => {
  ...
  let registerBag = (0, import_react78.useMemo)(
    () => ({
  ...
  (0, import_react78.useEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag), [registerPopover, registerBag]);
  let [portals, PortalWrapper] = useNestedPortals();
  ...
  let render2 = useRender();
  return /* @__PURE__ */ import_react78.default.createElement(MainTreeProvider, { node: mainTreeNode }, /* @__PURE__ */ import_react78.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react78.default.createElement(PopoverPanelContext.Provider, { value: null }, /* @__PURE__ */ import_react78.default.createElement(PopoverContext.Provider, { value: machine }, /* @__PURE__ */ import_react78.default.createElement(CloseProvider, { value: machine.actions.refocusableClose }, /* @__PURE__ */ import_react78.default.createElement(OpenClosedProvider, { value: openClosedState }, /* @__PURE__ */ import_react78.default.createElement(PortalWrapper, null, render2({
    ourProps,
    theirProps,
    slot,
...
function ButtonFn6(props, ref) {
  ...
  let [uniqueIdentifier] = (0, import_react78.useState)(() => Symbol());
  let buttonRef = useSyncRefs(
    internalButtonRef,
    ref,
    useFloatingReference(),
  ...
  let render2 = useRender();
  return /* @__PURE__ */ import_react78.default.createElement(import_react78.default.Fragment, null, render2({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BUTTON_TAG6,
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ import_react78.default.createElement(
    Hidden,
    {
      id: sentinelId,
...
function BackdropFn2(props, ref) {
  ...
  let popoverState = useSlice(
    machine,
    (0, import_react78.useCallback)((state) => state.popoverState, [])
  );
  let [localBackdropElement, setLocalBackdropElement] = (0, import_react78.useState)(null);
...
function PanelFn3(props, ref) {
  ...
  let internalPanelRef = (0, import_react78.useRef)(null);
  let anchor = useResolvedAnchor(rawAnchor);
  let [floatingRef, style] = useFloatingPanel(anchor);
  let getFloatingPanelProps = useFloatingPanelProps();
  if (anchor) {
  ...
  let [localPanelElement, setLocalPanelElement] = (0, import_react78.useState)(null);
  let panelRef = useSyncRefs(
    internalPanelRef,
    ref,
    anchor ? floatingRef : null,
  ...
  let render2 = useRender();
  return /* @__PURE__ */ import_react78.default.createElement(ResetOpenClosedProvider, null, /* @__PURE__ */ import_react78.default.createElement(PopoverPanelContext.Provider, { value: id }, /* @__PURE__ */ import_react78.default.createElement(CloseProvider, { value: machine.actions.refocusableClose }, /* @__PURE__ */ import_react78.default.createElement(
    Portal,
    {
      enabled: portal ? props.static || visible : false,
      ownerDocument: portalOwnerDocument
    },
    visible && isPortalled && /* @__PURE__ */ import_react78.default.createElement(
      Hidden,
      {
...
function GroupFn2(props, ref) {
  let internalGroupRef = (0, import_react78.useRef)(null);
  let groupRef = useSyncRefs(internalGroupRef, ref);
  let [popovers, setPopovers] = (0, import_react78.useState)([]);
  ...
  let contextBag = (0, import_react78.useMemo)(
    () => ({
      registerPopover,
      unregisterPopover,
  ...
  let ourProps = { ref: groupRef };
  let render2 = useRender();
  return /* @__PURE__ */ import_react78.default.createElement(MainTreeProvider, null, /* @__PURE__ */ import_react78.default.createElement(PopoverGroupContext.Provider, { value: contextBag }, render2({
    ourProps,
    theirProps,
    slot,
...
var RadioGroupDataContext = (0, import_react79.createContext)(null);
RadioGroupDataContext.displayName = "RadioGroupDataContext";
function useData3(component) {
  let context = (0, import_react79.useContext)(RadioGroupDataContext);
  if (context === null) {
...
var RadioGroupActionsContext = (0, import_react79.createContext)(null);
RadioGroupActionsContext.displayName = "RadioGroupActionsContext";
function useActions(component) {
  let context = (0, import_react79.useContext)(RadioGroupActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <RadioGroup /> component.`);
    if (Error.captureStackTrace)
...
function RadioGroupFn(props, ref) {
  ...
  let compare = useByComparator(by);
  let [state, dispatch] = (0, import_react79.useReducer)(stateReducer3, { options: [] });
  let options = state.options;
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let internalRadioGroupRef = (0, import_react79.useRef)(null);
  ...
  let firstOption = (0, import_react79.useMemo)(
    () => options.find((option) => {
  ...
  let containsCheckedOption = (0, import_react79.useMemo)(
  ...
  let radioGroupData = (0, import_react79.useMemo)(
    () => ({ value, firstOption, containsCheckedOption, disabled, compare, tabIndex, ...state }),
    [value, firstOption, containsCheckedOption, disabled, compare, tabIndex, state]
  );
  let radioGroupActions = (0, import_react79.useMemo)(
  ...
  let reset = (0, import_react79.useCallback)(() => {
    if (defaultValue === void 0)
      return;
    return triggerChange(defaultValue);
  }, [triggerChange, defaultValue]);
  let render2 = useRender();
  return /* @__PURE__ */ import_react79.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react79.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, /* @__PURE__ */ import_react79.default.createElement(RadioGroupActionsContext.Provider, { value: radioGroupActions }, /* @__PURE__ */ import_react79.default.createElement(RadioGroupDataContext.Provider, { value: radioGroupData }, name != null && /* @__PURE__ */ import_react79.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function OptionFn3(props, ref) {
  ...
  let internalOptionRef = (0, import_react79.useRef)(null);
  ...
  let render2 = useRender();
  return /* @__PURE__ */ import_react79.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react79.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, render2({
    ourProps,
    theirProps,
    slot,
...
function RadioFn(props, ref) {
  ...
  let internalRadioRef = (0, import_react79.useRef)(null);
...
function GroupFn4(props, ref) {
  ...
  let [state, dispatch] = (0, import_react82.useReducer)(stateReducer4, {
    info,
